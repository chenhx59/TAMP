...
from config.bk_config import args_type as bk_args_type
from dataset.tokenizer import BaseTokenizer
# from model.Trainer import NTMTrainer
from Rounder.Rounder import BkRecNTMRounder, McRecNTMRounder, NTMRounder, RecNTMRounder
...
def get_dataset(raw_data_file, binary_file, cache_dir, from_scratch):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default='bk')
    ...
    parser.add_argument('--num_epoch', default=3)
    ...
    train_dataset = get_dataset(args.train_data_file, args.train_binary_file, cache_dir, args.dataset_from_scratch)
    ...
    stop_words = ['is', 'and', 'then', 'there', 'are', 'of', 'a', 'the']
    stop_words = ['a', 'of', 'you', 'and', 'then', 'the', 'is', 'there', 'it', 'an', 'because']
